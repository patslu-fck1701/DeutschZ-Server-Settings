...
| Ronny1996 (GHOST) | `424575219219562503` | DeutschZ Ehrenmitglied, Supporter | volle Supporter-Funktionen; keine kritischen Freigaben | NEIN | Feedback, keine Statusentscheidung | JA |

## Verbindliche Regeln

- `OWNER_USER_ID` ist die alleinige Owner-only-Identität.
- `APPROVER_USER_IDS` enthält ausschließlich die drei Hauptfreigeber.
- Ronny erhält volle Supporter-Rechte, aber keine Upload-, Lösch-, Deployment-, Backup-, Raid- oder Hauptfreigabe.
